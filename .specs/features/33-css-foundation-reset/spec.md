...
|---|---|---|---|
| CSSF-01 | P1: Rendered app matches Tailwind classes | Design | Pending |
| CSSF-02 | P2: Every pairing clears WCAG AA | Design | Pending |
| CSSF-03 | P3: Regression guard | Design | Pending |
